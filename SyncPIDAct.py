...
writeResult = False
filenameCSV = 'Kp' + str(Kp) + 'Ki' + str(Ki) + 'Kd' + str(Kd) + 'V' + str(sysVel100) + 'D' + dist + '.csv'
...
while True:
    ...
    ##Uncomment next x_err and y_err lines to use estimated position error
    ##Calculate errors based on predicted position of target in next frame
